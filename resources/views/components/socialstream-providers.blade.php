...
<div class="flex items-center justify-center">
    @if (JoelButcher\Socialstream\Socialstream::hasFacebookSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::facebook()]) }}">
    ...
    @if (JoelButcher\Socialstream\Socialstream::hasGoogleSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::google()]) }}" >
    ...
    @if (JoelButcher\Socialstream\Socialstream::hasTwitterSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::twitter()]) }}">
    ...
    @if (JoelButcher\Socialstream\Socialstream::hasLinkedInSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::linkedin()]) }}">
    ...
    @if (JoelButcher\Socialstream\Socialstream::hasGithubSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::github()]) }}">
    ...
    @if (JoelButcher\Socialstream\Socialstream::hasGitlabSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::gitlab()]) }}">
    ...
    @if (JoelButcher\Socialstream\Socialstream::hasBitbucketSupport())
        <a class="p-4" href="{{ route('oauth.redirect', ['provider' => JoelButcher\Socialstream\Providers::bitbucket()]) }}">
            <x-bitbucket-icon />
